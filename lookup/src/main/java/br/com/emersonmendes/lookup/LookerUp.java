...
public class LookerUp {
	...
	public Object findLocalSessionBean(String earName, String moduleName, String beanName, String interfaceFullQualifiedName) throws NamingException{
 
		final Context context = new InitialContext(prop);
		Object object = context.lookup("java:global/" + earName + "/" + moduleName + "/" + beanName+"!" + interfaceFullQualifiedName);
		context.close();
